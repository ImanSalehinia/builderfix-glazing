...
const SLUG_IMAGES: Record<string, string> = {
  ...
  'upvc-vs-aluminium-windows':            'https://images.unsplash.com/photo-AncfqZVyGB4?auto=format&fit=crop&w=1200&q=80',
  'signs-need-new-windows':               'https://images.unsplash.com/photo-Fd9tUmRBJzk?auto=format&fit=crop&w=1200&q=80',
  'energy-efficient-windows-guide':       'https://images.unsplash.com/photo-U8zsjmKA840?auto=format&fit=crop&w=1200&q=80',
  'how-long-double-glazing-lasts':        'https://images.unsplash.com/photo-QzcmBsPBlfE?auto=format&fit=crop&w=1200&q=80',
  'window-energy-ratings':                'https://images.unsplash.com/photo-ohh8ROaQSJg?auto=format&fit=crop&w=1200&q=80',
  'aluminium-windows-cost-london':        'https://images.unsplash.com/photo-Ubq4cQFYH6M?auto=format&fit=crop&w=1200&q=80',
  'toughened-vs-laminated-glass':         'https://images.unsplash.com/photo-LmxAakMMgVk?auto=format&fit=crop&w=1200&q=80',
  'triple-glazing-worth-it':              'https://images.unsplash.com/photo-DdxY0rZq5ao?auto=format&fit=crop&w=1200&q=80',
  'triple-glazing-london-2025':           'https://images.unsplash.com/photo-ZzAsUYP9kQw?auto=format&fit=crop&w=1200&q=80',
  'misted-double-glazing-fix':            'https://images.unsplash.com/photo-E8fXT092H5o?auto=format&fit=crop&w=1200&q=80',
  'window-condensation-causes':           'https://images.unsplash.com/photo-sHPLvExW9oQ?auto=format&fit=crop&w=1200&q=80',
  'new-build-windows':                    'https://images.unsplash.com/photo-awFiJ8yQLSQ?auto=format&fit=crop&w=1200&q=80',
  'window-noise-reduction':               'https://images.unsplash.com/photo-oRm2TfiHG0U?auto=format&fit=crop&w=1200&q=80',
  'acoustic-secondary-glazing-london':    'https://images.unsplash.com/photo-TsL2xUf9uOM?auto=format&fit=crop&w=1200&q=80',
  'secondary-glazing-cost':               'https://images.unsplash.com/photo-qyQE1KfBwA4?auto=format&fit=crop&w=1200&q=80',
  'secondary-glazing-noise-reduction':    'https://images.unsplash.com/photo-OTB3zBBBpSg?auto=format&fit=crop&w=1200&q=80',
  'frameless-bifold-doors-london':        'https://images.unsplash.com/photo-FecowCYyLcY?auto=format&fit=crop&w=1200&q=80',
  'landlord-window-obligations':          'https://images.unsplash.com/photo-Xa2ysnML9y0?auto=format&fit=crop&w=1200&q=80',
  // ── Bi-fold & patio doors ─────────────────────────────────────────────
  'bifold-doors-cost-uk':                 'https://images.unsplash.com/photo-DOYyY1CWbz0?auto=format&fit=crop&w=1200&q=80',
  'bifold-vs-patio-doors':                'https://images.unsplash.com/photo-0urGOJxRcmk?auto=format&fit=crop&w=1200&q=80',
  'bifold-door-ideas':                    'https://images.unsplash.com/photo-QmiR1c9azJY?auto=format&fit=crop&w=1200&q=80',
  'aluminium-bifold-doors-maintenance':   'https://images.unsplash.com/photo-OIq-xpb0gbU?auto=format&fit=crop&w=1200&q=80',
  'bifold-doors-kensington-chelsea':      'https://images.unsplash.com/photo-et5Xymmpbbk?auto=format&fit=crop&w=1200&q=80',
  // ── Composite & front doors ───────────────────────────────────────────
  'composite-door-cost':                  'https://images.unsplash.com/photo-oxvfnWJ32io?auto=format&fit=crop&w=1200&q=80',
  // ── Sash & Victorian / heritage windows ───────────────────────────────
  'sash-window-restoration-guide':        'https://images.unsplash.com/photo-b5ApUwSn7VI?auto=format&fit=crop&w=1200&q=80',
  'sash-window-draught-proofing':         'https://images.unsplash.com/photo-7B7mZNZtKtc?auto=format&fit=crop&w=1200&q=80',
  'london-victorian-windows':             'https://images.unsplash.com/photo-TLy5giUzq_I?auto=format&fit=crop&w=1200&q=80',
  'conservation-area-windows':            'https://images.unsplash.com/photo-4XG64v4H8xY?auto=format&fit=crop&w=1200&q=80',
  'sash-windows-mayfair-belgravia':       'https://images.unsplash.com/photo-GzY8TSG9QdQ?auto=format&fit=crop&w=1200&q=80',
  'glazing-bars-guide':                   'https://images.unsplash.com/photo-MAtqHsVoNNg?auto=format&fit=crop&w=1200&q=80',
  // ── Security, locks & planning ────────────────────────────────────────
  'window-fensa-certificate':             'https://images.unsplash.com/photo-KPHDEGh-SIY?auto=format&fit=crop&w=1200&q=80',
  'planning-permission-windows':          'https://images.unsplash.com/photo-nsdBZWoDO7Y?auto=format&fit=crop&w=1200&q=80',
  'window-draught-proofing':              'https://images.unsplash.com/photo-TR60oy_6CMM?auto=format&fit=crop&w=1200&q=80',
  'window-security-guide':                'https://images.unsplash.com/photo-Ibj4oa-Mw3U?auto=format&fit=crop&w=1200&q=80',
  'anti-snap-locks-guide':                'https://images.unsplash.com/photo-7PEPsadntDY?auto=format&fit=crop&w=1200&q=80',
  'window-handles-locks-upgrade':         'https://images.unsplash.com/photo-timI6B32HKg?auto=format&fit=crop&w=1200&q=80',
  'break-in-glass-repair':                'https://images.unsplash.com/photo-xXfw9BQeKxU?auto=format&fit=crop&w=1200&q=80',
  // ── Emergency glazing ─────────────────────────────────────────────────
  'emergency-glazing-what-to-do':         'https://images.unsplash.com/photo-_esBifcu1CU?auto=format&fit=crop&w=1200&q=80',
  'emergency-glazier-london-24-7':        'https://images.unsplash.com/photo-NeK5dKVhnig?auto=format&fit=crop&w=1200&q=80',
  // ── Shower, bathroom & kitchen glass ─────────────────────────────────
  'frameless-shower-enclosure-guide':     'https://images.unsplash.com/photo-rDSwQ_6XFUs?auto=format&fit=crop&w=1200&q=80',
  'best-glass-bathroom':                  'https://images.unsplash.com/photo-48mTwDzizqE?auto=format&fit=crop&w=1200&q=80',
  'obscure-glass-bathroom':               'https://images.unsplash.com/photo-g51F6-WYzyU?auto=format&fit=crop&w=1200&q=80',
  'glass-splashback-guide':               'https://images.unsplash.com/photo-IcxGHnqoy-Y?auto=format&fit=crop&w=1200&q=80',
  'glass-splashback-colours':             'https://images.unsplash.com/photo-thpj-Xk0Qjo?auto=format&fit=crop&w=1200&q=80',
  // ── Balustrade, staircase & walk-on glass ─────────────────────────────
  'glass-balustrade-guide':               'https://images.unsplash.com/photo-n-ebvE52gJg?auto=format&fit=crop&w=1200&q=80',
  'glass-staircase-ideas':                'https://images.unsplash.com/photo-j1PU4Buvqbs?auto=format&fit=crop&w=1200&q=80',
  'glass-balustrade-cost-london':         'https://images.unsplash.com/photo-AIvKJfwMcd8?auto=format&fit=crop&w=1200&q=80',
  'walk-on-glass-floor-cost-london':      'https://images.unsplash.com/photo-A71hpMTGZ4I?auto=format&fit=crop&w=1200&q=80',
  // ── Commercial glazing ────────────────────────────────────────────────
  'shop-front-glazing-guide':             'https://images.unsplash.com/photo-r7PA4LYaySo?auto=format&fit=crop&w=1200&q=80',
  'office-glass-partitions-guide':        'https://images.unsplash.com/photo-mzOIHBsoFbE?auto=format&fit=crop&w=1200&q=80',
  'automatic-doors-guide':                'https://images.unsplash.com/photo-tvJOR05xJ0o?auto=format&fit=crop&w=1200&q=80',
  // ── Luxury & inspiration ──────────────────────────────────────────────
  'luxury-glazing-london-townhouses':     'https://images.unsplash.com/photo-irqcS2UsBbA?auto=format&fit=crop&w=1200&q=80',
  // ── Location area pages ───────────────────────────────────────────────
  'glazing-kensington-chelsea':           'https://images.unsplash.com/photo-EwIh1o0PpDI?auto=format&fit=crop&w=1200&q=80',
  'glazing-brentford':                    'https://images.unsplash.com/photo-EAwV4grbzSc?auto=format&fit=crop&w=1200&q=80',
  'glazing-richmond':                     'https://images.unsplash.com/photo-Y9QFbo8Vxc0?auto=format&fit=crop&w=1200&q=80',
  'glazing-ealing':                       'https://images.unsplash.com/photo-d7dOlN9jF7g?auto=format&fit=crop&w=1200&q=80',
  'glazing-chiswick':                     'https://images.unsplash.com/photo-Ye8mxE9Vdcs?auto=format&fit=crop&w=1200&q=80',
  'glazing-wimbledon':                    'https://images.unsplash.com/photo-KZkokezFzp4?auto=format&fit=crop&w=1200&q=80',
}
